    ...
    <Card className="border mb-2 md:mb-0" imgSrc={picture}>
      ...
      <div className="flex flex-col gap-2 font-normal text-gray-500">
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center justify-center gap-1 border px-1 rounded-md text-gray-500 text-sm">
      ...
      <Link
        to={`/chef-details/${id}`}
        type="button"
        className="w-full bg-gray-300 text-gray-500 border border-gray-300 hover:bg-gray-500 hover:text-white font-medium rounded-md text-sm px-5 py-2 text-center"
      >
        View Recipes
      </Link>
    </Card>
